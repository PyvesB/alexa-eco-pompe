...
public enum Messages {;
	...
	public static final String LAUNCH = "Bienvenue ! Je peux trouver le carburant le moins cher par ville, par département ou près de vous. Dîtes \"aide\" pour obtenir les instructions, ou \"stop\" pour quitter Éco Pompe.";
