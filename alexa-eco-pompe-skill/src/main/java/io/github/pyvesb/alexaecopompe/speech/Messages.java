...
public enum Messages {;
	...
	public static final String NO_STATION_FOUND = "Je n'ai pas trouvé de pompe vendant $TYPE dans $LOCATION.";
	...
	public static final String INCORRECT_RADIUS = "Veuillez fournir une distance comprise entre 1 et 20 kilomètres. Par exemple : \"le sans plomb 95 à moins de 10 kilomètres\".";
